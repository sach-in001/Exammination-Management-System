...
public class PythonExamPage2 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PythonExamPage2 window = new PythonExamPage2();
	...
	private void initialize() {
		...
		frmAssianInstituteOf.setIconImage(Toolkit.getDefaultToolkit().getImage(PythonExamPage2.class.getResource("/images/Alogo.jpg")));
