...
public class CexamPage2 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CexamPage2 window = new CexamPage2();
	...
	private void initialize() {
		...
		frmAssianInstituteOf.setIconImage(Toolkit.getDefaultToolkit().getImage(CexamPage2.class.getResource("/images/Alogo.jpg")));
