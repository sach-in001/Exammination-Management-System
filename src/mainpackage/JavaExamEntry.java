...
public class JavaExamEntry {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JavaExamEntry window = new JavaExamEntry();
	...
	private void initialize() {
		...
		frmAssianInstituteOf.setIconImage(Toolkit.getDefaultToolkit().getImage(JavaExamEntry.class.getResource("/images/Alogo.jpg")));
		...
		JLabel lblNewLabel_2 = new JLabel("Java Programming");
